...
-->
Implement the yourskill-mcp stdio MCP server with CLI, skill loading from repos/paths, cache, and README per spec.
...
-->
1. Which FastMCP APIs do we need to expose resources from SKILL.md files?
2. What is the minimal on-disk cache structure that satisfies "rebuildable"?
...
|-------|---------|------------|
| session-catchup.py not found (CLAUDE_PLUGIN_ROOT unset) | 1 | Used explicit template path to initialize planning files; proceed without catchup |
